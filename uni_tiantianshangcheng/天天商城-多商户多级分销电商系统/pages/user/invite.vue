<template>
	<view class="invite-container">
		<image src="/static/images/invite.jpg" class="img" mode="aspectFill" @click="showPop()"></image>
		<view class="code">
			...
			<view class="codeDialog">
				...
				<view class="info">
					...
					<canvas class="canvas-hide" canvas-id="qrcode"
						style="width: 140px;height: 140px;margin:0 auto;"></canvas>
					...
					<view class="text-center padding-10" @click="closePop('codePopup')">
						<tian-icons type="guanbi2" size="40"></tian-icons>
					</view>
				</view>
			</view>
		</uni-popup>
