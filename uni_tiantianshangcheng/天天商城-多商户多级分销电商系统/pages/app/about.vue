<template>
	<view>
		...
		<uni-list>
			<uni-list-item title="服务协议" :showArrow="true" :clickable="true"
				@click="navTo('/pages/app/web',appConfig.fwxy)">
			</uni-list-item>
			<uni-list-item title="隐私政策" :showArrow="true" :clickable="true"
				@click="navTo('/pages/app/web',appConfig.yszc)">
			</uni-list-item>
			<uni-list-item title="资质证照" :showArrow="true" :clickable="true"
