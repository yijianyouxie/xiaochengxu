...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"天天商城-多商户多级分销电商系统","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 104:
/*!*******************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/validator/tian-mall-shop-apply.js ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.enumConverter = exports.validator = void 0; // 表单校验规则由 schema2code 生成，不建议直接修改校验规则，而建议通过 schema2code 生成, 详情: https://uniapp.dcloud.net.cn/uniCloud/schema
...
var validator = {
  ...
  "modified": {
    ...
    "defaultValue": {
      "$env": "now" } } };exports.validator = validator;
...
var enumConverter = {
  "state_valuetotext": {
    "0": "审核中",
    "1": "通过",
    "2": "拒绝" } };exports.enumConverter = enumConverter;
...
//二维数组去重
exports.dateFormat = dateFormat;var getUnique = function getUnique(array) {
  var obj = {};
...
var thumbImg = function thumbImg(value, fmt) {
  if (!fmt) {
    fmt = "200x200";
  }
  if (!value) {
  ...
  //可能出现地址里面有问号
  if (value.indexOf("?") > 0) {var _value$split =
    value.split("?"),_value$split2 = _slicedToArray(_value$split, 2),path = _value$split2[0],query = _value$split2[1];
    value = path;
  }
  fmt = fmt.toLowerCase();
  if (value.indexOf("bspapp.com") > -1) {
    var wh = fmt.split("x");
    fmt = "w_".concat(wh[0], ",h_").concat(wh[1]);
    ...
    var _wh2 = fmt.split("x");
    var maxWidth = Math.max.apply(Math, _toConsumableArray(_wh2));
...
var stringFormat = function stringFormat(format, data) {var defaultEmpty = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  if (!format) {
    return "";
  }
  //匹配大括号+英文字符
  return format.replace(/\{([a-zA-Z0-9$_\.]+)\}/g, function (key) {
    //去掉大括号，得到变量
    ...
    var keyArr = key1.split(".");
    if (keyArr.length > 1) {
      var tmp = data[keyArr[0]];
      keyArr.shift();var _iterator = _createForOfIteratorHelper(
      keyArr),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var key2 = _step.value;
          tmp = tmp[key2];
          if (tmp === undefined) {
            return key1;
          }
...
var repairImageSize = function repairImageSize(data) {
  if (!data) {
    return "";
  }
  ...
  //匹配src属性
  var srcReg = /src=[\'\"]?([^\'\"]*)[\'\"]?/i;
  return data.replace(imgReg, function (key) {
    console.log(key);
    var src = key.match(srcReg);
    if (src[1]) {
      return "<img src=\"".concat(src[1], "\" width=\"100%\"/>");
    }
    return "";
  });
};
/**
    * 保存文件到本地
    */exports.repairImageSize = repairImageSize;
var saveFile = function saveFile(url, isSave, callback) {
  uni.downloadFile({
    url: url,
...
/***/ 159:
/*!*************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/mixin/upload.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {Object.defineProperty(exports, "__esModule", { value: true });exports.cloudUploadFile = exports.uploadFiles = void 0; /**
                                                                                                                                    * 批量上传多个文件
                                                                                                                                    ...
                                                                                                                                    */
var uploadFiles = function uploadFiles(name, number, chooseCallback, successCallback) {
  var day = new Date();
  var pathArr = [name, day.getFullYear(), day.getMonth() + 1, day.getDate()];
  uni.chooseImage({
    count: number,
    success: function success(res) {
      var paths = [];
      ...
      var promises = [];
      //循环上传
      res.tempFilePaths.map(function (filePath) {
        var fname = (Math.random() + '').substr(2) + '.jpg';
        var cpath = pathArr.join('/') + '/' + fname;
        var uploadPromise = cloudUploadFile(filePath, cpath);
...
var cloudUploadFile = function cloudUploadFile(filePath, cpath) {
  //构造云端地址
  if (!cpath) {
    var day = new Date();
    var field = uni.getStorageSync("avatarField");
    if (!field) {
      field = "user";
    }
    var p = [field, 'images', day.getFullYear(), day.getMonth() + 1, day.
    getDate(), day.getTime() + '.jpg'];

    cpath = p.join('/');
  }
  return new Promise(function (resolve, reject) {
    var result = uniCloud.uploadFile({
      filePath: filePath,
      cloudPath: cpath,
      onUploadProgress: function onUploadProgress(pro) {},
      success: function success(res) {
...
/***/ 17:
/*!*****************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/store/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 18:
/*!***************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/store/modules sync \.js$ ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 180:
/*!***********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/js/uqrcode.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 19:
/*!***********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/store/modules/app.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 9));var _request = __webpack_require__(/*! @/js_sdk/mall/request.js */ 20);


var _util = __webpack_require__(/*! @/common/js/util.js */ 13);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */var _default =
{
  ...
  state: {
    ...
    appName: "天天商城-多商户多级分销电商系统" || false },
  ...
  getters: {
    /**
              ...
              * @param {Object} state
              */
    isMustUniverifyLogin: function isMustUniverifyLogin(state) {
  ...
  mutations: {
    ...
    SET_APP_AD: function SET_APP_AD(state, adConfig) {
      state.adConfig = adConfig;
    },
    SET_APP_MUST_UNIVERIFY: function SET_APP_MUST_UNIVERIFY(state, mustUniverify) {
  ...
  actions: {
    ...
    payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, commit;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref.state, commit = _ref.commit;
                if (!payload) {
                  payload = {};
                }
                state.pageConfig = {};
                ...
                console.log("store app init", payload);return _context.abrupt("return",
                (0, _request.request)('app/init', payload).
                then(function (res) {var
                  ...
                  res.navMenu,appName = res.appName,userInfo = res.userInfo,share = res.share,customer = res.customer,mustUniverify = res.mustUniverify,mustBindMobile = res.mustBindMobile,pageConfig = res.pageConfig,adConfig = res.adConfig;
                  state.share = share;
...
/***/ 20:
/*!*************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/mall/request.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uniCloud, uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.request = request;exports.initRequest = initRequest;var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 17));
var _config = _interopRequireDefault(__webpack_require__(/*! @/config.js */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
var isShowLoginDialog = false;
var db = uniCloud.database();
db.on('refreshToken', function (_ref)
...
{var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},_ref2$showModal = _ref2.showModal,showModal = _ref2$showModal === void 0 ? true : _ref2$showModal,_ref2$loading = _ref2.loading,loading = _ref2$loading === void 0 ? false : _ref2$loading,_ref2$functionName = _ref2.functionName,functionName = _ref2$functionName === void 0 ? "tiantian-mall" : _ref2$functionName,_ref2$checkAuthInvali = _ref2.checkAuthInvalid,checkAuthInvalid = _ref2$checkAuthInvali === void 0 ? false : _ref2$checkAuthInvali;
  if (loading) {
    uni.showLoading({
      title: "加载中",
      mask: true });
  ...
  {var result = _ref3.result;
    ...
    if (result.code) {
      ...
      var err = _objectSpread(_objectSpread({},
      result), {}, {
        message: message });
    ...
    result.token,tokenExpired = result.tokenExpired,type = result.type,uid = result.uid,userInfo = result.userInfo;
...
function initRequest(Vue) {
  ...
  Vue.prototype.$config = _config.default;
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__F80C472" };exports.default = _default;

/***/ }),

/***/ 23:
/*!************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/config.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  qqmapWxKey: 'ZWYBZ-HOSWD-S2X4S-HHPBQ-YKY7Z-5NFK5', //腾讯地图小程序sdk key 配置域名白名单 https://apis.map.qq.com
  login: {
  ...
  app: {
    yszc: "http://tian.cqsort.com/markdown-share-docs/b239949abb45d686b40445f494899baa/",
    fwxy: "http://tian.cqsort.com/markdown-share-docs/1999bd540442b351336bc2b778666ef5/",
    zz: "http://tian.cqsort.com/markdown-share-docs/68947cddaa61e0e0f7a700389e63534c/" },

  error: {
    url: '/pages/index/index' // 404 Not Found 错误页面路径
  } };exports.default = _default;
...
/***/ 239:
/*!*****************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/validator/tian-user-cashouts.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var validator = {
  ...
  "mode": {
    ...
    "defaultValue": "wxpay",
    "label": "提现方式" } };exports.validator = validator;
...
var enumConverter = {
  ...
  "mode_valuetotext": {
    "wxpay": "微信",
    "alipay": "支付宝",
    "bank": "银行卡" } };exports.enumConverter = enumConverter;

/***/ }),

/***/ 24:
/*!************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/store/modules/mall.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */var _default =
{
  ...
  mutations: {
    /**
                * 切换主分类，在分类菜单，需要选中
                */
    TOGGLE_CATEGORY_ACTIVE: function TOGGLE_CATEGORY_ACTIVE(state, category) {
      state.mainCategory = category;
    },
    /**
        * 设置购物车总数量
        */
    UPDATE_CART_NUMBER: function UPDATE_CART_NUMBER(state, number) {
      state.cartCount = number;
    },
    /**
        * 递增/递减购物车总数量
        */
    INCREMENT_CART_NUMBER: function INCREMENT_CART_NUMBER(state, step) {
      console.log("递增购物车数量", step);
      state.cartCount += step;
    },
    UPDATE_ARTICLE_READ: function UPDATE_ARTICLE_READ(state, id) {
      //不用重复增加
  ...
  actions: {
    getCartTotal: function getCartTotal(_ref)
...

    {
      ...
      if (isLogin) {
      	...
      	state.cartCount = 0;
      } */return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, commit;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref.state, commit = _ref.commit;case 1:case "end":return _context.stop();}}}, _callee);}))();
    } } };exports.default = _default;
...
/***/ 25:
/*!************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/store/modules/user.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 9));var _request = __webpack_require__(/*! @/js_sdk/mall/request.js */ 20);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */var _default =
{
  ...
  getters: {
    ...
    isInitTokenValid: function isInitTokenValid(state) {
  ...
  mutations: {
    ...
    {var token = _ref.token,tokenExpired = _ref.tokenExpired,userInfo = _ref.userInfo,openid = _ref.openid;
      state.token = token;
      ...
      //用于下次自动登录
      uni.setStorageSync('uni_id_token', token);uni.setStorageSync('uni_id_token_expired', tokenExpired);
    ...
    SET_USER_INFO: function SET_USER_INFO(state, userInfo) {
      ...
      if (userInfo._id) {
        ...
        defUserInfo = Object.assign({}, _objectSpread(_objectSpread({},
        defUserInfo),
        info));
      ...
      state.userInfo = Object.assign({}, _objectSpread(_objectSpread({},
      defUserInfo),
      userInfo));
    ...
    UPDATE_MULTI_ACCOUNT: function UPDATE_MULTI_ACCOUNT(state) {
      var userInfo = state.userInfo;
      if (!userInfo._id) {
        return false;
      }
      //多账户管理，写入缓存
      var key = 'tiantian-accounts';
      var accounts = uni.getStorageSync(key);
      if (!accounts) {
        accounts = [];
      }
      var saveInfo = _objectSpread(_objectSpread({},
      userInfo), {}, {
        token: state.token,
        tokenExpired: state.tokenExpired });

      //判断是否存在
      if (accounts.filter(function (e) {return e._id == userInfo._id;}).length == 0) {
        //不存在，直接写入
    ...
    /**
        ...
        * @param {Object} code
        */
    SET_INVITECODE: function SET_INVITECODE(state, code) {
      state.inviteCode = code;
    },
    SET_CHANNELCODE: function SET_CHANNELCODE(state, code) {
    ...
    /**
        ...
        * @param {Object} push
        */
    UPDATE_PUSH_CLIENT: function UPDATE_PUSH_CLIENT(state, push) {
      state.push = push;
      this.dispatch('user/updatePushClient');
    },
    UPDATE_TASK_LOG: function UPDATE_TASK_LOG(state, log) {
      if (state.tasks && log.task_id) {
        state.tasks.forEach(function (task) {
          if (task._id == log.task_id) {
            task.log = _objectSpread(_objectSpread({},
            log), {}, {
              task: undefined });
    ...
    MP_AUTO_LOGIN: function MP_AUTO_LOGIN(state, info) {
      this.dispatch('user/mpLogin', info);
    },
    MP_WX_CODE: function MP_WX_CODE(state, mpWxCode) {
      state.mpWxCode = mpWxCode;
      console.log("更新微信code完成", state.mpWxCode);
    },
    UNIVERIFY_INIT: function UNIVERIFY_INIT(state, info) {
  ...
  actions: {
    ...
    {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, dispatch, commit, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref2.state, dispatch = _ref2.dispatch, commit = _ref2.commit;
                console.log("store getUserInfo");_context.next = 4;return (
                  (0, _request.request)('user/info/info', {}, {
                    checkAuthInvalid: false,
                    token: state.token }));case 4:res = _context.sent;

                if (res) {
                  commit('SET_USER_INFO', res);
                }
                console.log("store getUserInfo result", res);case 7:case "end":return _context.stop();}}}, _callee);}))();
    },
    /**
    ...
    payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var state, commit, res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:state = _ref3.state, commit = _ref3.commit;if (!(
                state.tasks.length == 0 || payload)) {_context2.next = 7;break;}_context2.next = 4;return (
                  (0, _request.request)('user/task/all', {}, {}));case 4:res = _context2.sent;
                state.tasks = res;
                console.log("store getTasks", res);case 7:case "end":return _context2.stop();}}}, _callee2);}))();

    },
    /**
        * 更新推送信息
        */
    updatePushClient: function updatePushClient(_ref4)


    {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var state, commit, res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:state = _ref4.state, commit = _ref4.commit;if (!(
                state.token && state.push)) {_context3.next = 6;break;}_context3.next = 4;return (
                  (0, _request.request)('user/info/push', _objectSpread({},
                  state.push),
                  {
                    checkAuthInvalid: true,
                    token: state.token }));case 4:res = _context3.sent;

                console.log("store 更新用户推送信息成功", res);case 6:case "end":return _context3.stop();}}}, _callee3);}))();

    },
    /**
        * 小程序登录
        */
    mpLogin: function mpLogin(_ref5,


    payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var state, commit, res;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:state = _ref5.state, commit = _ref5.commit;_context4.next = 3;return (
                  (0, _request.request)('user/login/' + payload.provider, _objectSpread({},
                  payload)));case 3:res = _context4.sent;
                ...
                console.log("store mpLogin", res);case 6:case "end":return _context4.stop();}}}, _callee4);}))();
    } } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 26:
/*!************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/mall/plugin.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _util = __webpack_require__(/*! ./util.js */ 27);


var _request = __webpack_require__(/*! ./request.js */ 20);


var _interceptor = __webpack_require__(/*! ./interceptor.js */ 28);
...
var _permission = __webpack_require__(/*! ./permission.js */ 29);var _default =
...

{
  install: function install(Vue) {
    ...
    (0, _interceptor.initInterceptor)(Vue);
...
/***/ 264:
/*!*************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/validator/uni-id-channel.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var enumConverter = {
  "status_valuetotext": {
    ...
    "1": "审核中",
    "2": "通过",
    "3": "审核拒绝" } };exports.enumConverter = enumConverter;

/***/ }),

/***/ 27:
/*!**********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/mall/util.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.initUtil = initUtil;exports.getDeviceUUID = getDeviceUUID;var _util = __webpack_require__(/*! @/common/js/util.js */ 13);
...
/**
   * 普通消息
   */
function message() {var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1500;var icon = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'none';var mask = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  uni.hideLoading();
  if (!title) return;
  uni.showToast({
    title: title,
...
/**
   * 操作成功消息
   */
function success() {var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1500;var mask = arguments.length > 2 ? arguments[2] : undefined;
  message(title, duration, 'success', mask);
}
function initUtil(Vue) {
  Vue.prototype.$dateFormat = _util.dateFormat;
  Vue.prototype.$formatBytes = formatBytes;
  Vue.prototype.$message = message;
  Vue.prototype.$success = success;
  Vue.prototype.$throttle = _util.throttle;
  Vue.prototype.$getUnique = _util.getUnique;
  Vue.prototype.$thumbImg = _util.thumbImg;
  Vue.prototype.$prePage = _util.prePage;
  Vue.prototype.$repairImageSize = _util.repairImageSize;
  Vue.prototype.$stringFormat = _util.stringFormat;
}
...
/***/ 273:
/*!*************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/validator/uni-id-address.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var validator = {
  ...
  "is_default": {
    ...
    "defaultValue": false,
    "label": "默认地址" } };exports.validator = validator;
...
/***/ 28:
/*!*****************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/mall/interceptor.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.initInterceptor = initInterceptor;var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 17));
var _config = _interopRequireDefault(__webpack_require__(/*! @/config.js */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function initInterceptor(Vue) {
  /**
                                * 登录信息过滤器
                                */
  uni.addInterceptor('navigateTo', {
    invoke: function invoke(params) {
      var isAdminUrl = params.url.indexOf("pages/admin") != -1;
      //不是所有的地址都需要登录权限
      if ((params.url.indexOf("login=true") != -1 || isAdminUrl) && !_store.default.getters['user/isTokenValid']) {
        uni.showModal({
          title: _config.default.login.title,
          content: _config.default.login.content,
          showCancel: false,
          success: function success() {
            uni.navigateTo({
              url: _config.default.login.url });
    ...
    {var errMsg = _ref.errMsg;
      if (errMsg.indexOf('is not found') !== -1) {// 404
        uni.navigateTo({
          url: _config.default.error.url + '?errMsg=' + errMsg });
...
/***/ 29:
/*!****************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/js_sdk/mall/permission.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 30:
/*!************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/mixin/mixin.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! @/config.js */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}var _default =
{
  data: function data() {
    return {
      page: 0, //页码
  ...
  watch: {
    barTitle: function barTitle(newVal) {
  ...
  methods: {
    ...
    /**
        ...
        */
    navTo: function navTo(url, item) {var _this = this;var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      if (!url) {
        return;
      }
      console.log("url", url);
      ...
      if (url.indexOf("miniProgram") != -1) {
        ...
        //触发本地方法，带简单参数
        var _args = url.split(",");
        var funcs = _args.shift();
        try {
          this[funcs.substr(2)].apply(this, [item].concat(_toConsumableArray(_args)));
        } catch (e) {
          console.log(e);
          uni.showToast({
        ...
        fail: function fail() {
          ...
          uni.switchTab({
            ...
            success: function success() {
              ...
              1) {
                var cid = url.substr(url.indexOf("id=") + 3);
    ...
    /**
        ...
        * @param {Object} item
        */
    redirectToItem: function redirectToItem(url, item) {
      if (item) {
        uni.setStorageSync(this.itemDataKey, item);
      }
      uni.redirectTo({
    ...
    navToLoginNotice: function navToLoginNotice(callback) {var fullScreen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;var toLogin = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      //是否已经弹出
      if (this.isShowLoginDialog) {
        return false;
      }
      var errorMsg = "一键登录失败，请打开手机流量";
      var isMustUniverifyLogin = this.$store.getters['app/isMustUniverifyLogin'];
      var univerifyInit = this.$store.state.user.univerifyInit;
      //app默认直接弹出一键登录授权
    ...
    showLoginNotice: function showLoginNotice() {var _this2 = this;
      uni.showModal({
        title: _config.default.login.title,
        content: _config.default.login.content,
        cancelText: _config.default.login.cancelText,
        confirmText: _config.default.login.confirmText,
        success: function success(res) {
          if (res.confirm) {
            _this2.navToLogin();
          }
          _this2.isShowLoginDialog = false;
        },
        fail: function fail() {
          _this2.isShowLoginDialog = false;
        } });
    ...
    /**
        ...
        */
    navTimeBack: function navTimeBack(isRefresh) {var _this3 = this;var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2000;var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      setTimeout(function () {
        if (isRefresh) {
          try {
            //需要上一个页面定义loadData
    ...
    /**
        ...
        */
    getItemData: function getItemData(isAutoSet) {
      var data = uni.getStorageSync(this.itemDataKey);
      if (isAutoSet && data) {
        //数组不允许设置
    ...
    setRootData: function setRootData(data) {
      for (var key in data) {
        this[key] = data[key];
      }
    },
    /**
        ...
        * @param {Object} time 跳转时间
        */
    navTimeTo: function navTimeTo(url) {var _this4 = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2000;
      setTimeout(function () {
        _this4.navTo(url, options);
      }, time);
    },
    imageOnLoad: function imageOnLoad(data, key) {var _this5 = this;
      //这里有问题，页面数据重新刷新后，图片地址为改变的时候，不触发图片的load事件，
      setTimeout(function () {
        _this5.$set(data, 'loaded', true);
      }, 100);
    },
    showMyPopups: function showMyPopups(key) {var _this6 = this;
      this.$api.throttle(function () {
        _this6.$refs[key].open();
      }, 200);
    },
    hideMyPopups: function hideMyPopups(key) {
      this.$refs[key].close();
    },
    ...
    /**
                                             ...
                                             * @param {Object} path
                                             */
    getShareContent: function getShareContent(path) {var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];var redirect = arguments.length > 2 ? arguments[2] : undefined;
      var imageUrl,title = "";
      ...
      if (redirect) {
        ...
        query.push("rdt=".concat(redirect));
      }
    ...
    /**
        ...
        * @param {Object} title
        */
    confirmAction: function confirmAction(callback) {var content = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
    ...
    /**
        ...
        * @param {Object} data
        */
    buildMember: function buildMember(data) {
      var info = {
        balance: 0,
        score: 0,
        coupon: 0,
    ...
    checkBindMobile: function checkBindMobile(content) {var _this7 = this;
      ...
      mustBindMobile && !info.mobile) {
        ...
        uni.showModal({
          ...
          success: function success(res) {
            if (res.confirm) {
              _this7.navTo("/pages/login/bindmobile");
            }
          } });
    ...
    setGlobalShareContent: function setGlobalShareContent(share) {
      if (!share) {
      ...
      if (share && userInfo && userInfo._id) {
        for (var key in share) {
          share[key] = this.$stringFormat(share[key], _objectSpread({},
          userInfo),
          true);
        }
...
/***/ 31:
/*!**********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/js/filter.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _util = __webpack_require__(/*! @/common/js/util */ 13);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                       ...
                                                                                                                                       */
_vue.default.filter('dateFormat', function (timeStamp) {var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Y-m-d H:i';
  if (!timeStamp) return '';
  return (0, _util.dateFormat)(format, timeStamp);
});

/**
     * 处理距离
     */
_vue.default.filter('formatDistance', function (value) {
  if (!value) {
    return "0m";
  }
  if (value < 1000) {
...
/**
     * 处理距离到达时间
     */
_vue.default.filter('formatDistanceTime', function (value) {
  if (!value) {
    return "0m";
  }
  if (value < 10) {
  ...
  var str = "";
  var minute = parseInt(value / 1000 * 30);
  if (minute / 60 > 1) {
...
_vue.default.filter('substr', function (value) {var length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
  if (!value) {
    return "";
...
/**
     * 性别默认头像
     */
_vue.default.filter('genderAvatar', function (e) {
  if (e == 1) {
...
/**
     * 性别文字
     */
_vue.default.filter('genderValue', function (e) {
  if (e == 1) {
    return '女';
  } else if (e == 2) {
    return '男';
...
/**
     ...
     * @param {Object} fmt 宽x高 200x200
     */
_vue.default.filter('thumbImg', function (value, fmt) {
  return (0, _util.thumbImg)(value, fmt);
});
...
/***/ 38:
/*!******************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/pages/index/mixin/tabbar.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  methods: {
    checkInviter: function checkInviter() {
      var info = this.$store.state.user.userInfo;
...
/***/ 39:
/*!*********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/mixin/ad.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _adMpWeixin = _interopRequireDefault(__webpack_require__(/*! @/common/js/ad-mp-weixin.js */ 40));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =

{
  ...
  computed: {
    videoAdWaittingTime: function videoAdWaittingTime() {
      //视频广告完成后，需要等待时长
  ...
  onShow: function onShow() {
    ...
    _adMpWeixin.default.destory();

  },
  methods: {
    loadVideoAd: function loadVideoAd() {
    ...
    loadVideoAdByConfig: function loadVideoAdByConfig(config) {
    ...
    articleRead: function articleRead(task) {
      console.log("阅读文章赚积分");
      return this.finishTask(task, "finish", {}, false);
    },
    view_aritcle: function view_aritcle() {
      uni.switchTab({
        url: "/pages/index/index" });

    },
    getDoubleScore: function getDoubleScore(task, module) {
    ...
    shareToFriend: function shareToFriend(task) {var _this = this;
      var data = this.$stringFormat(task.data, {
      ...
      JSON.parse(data)), {}, {
        success: function success(res) {
          _this.finishTask(task, "share", {}, false);
    ...
    showRewardedVideoAd: function showRewardedVideoAd(task) {var _this2 = this;var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "signin";var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      // 调用后会显示 loading 界面
      _adMpWeixin.default.show(config, function (res) {
        _this2.loadVideoAdByConfig(config);
        // 用户点击了【关闭广告】按钮，后台允许中途退出
        if (res && res.isEnded || task.middle_getout) {
          // 正常播放结束
          _this2.finishTask(task, type, data);
        ...
        if (err.errMsg && err.errMsg.indexOf("广告加载失败") != -1) {
          ...
          _this2.showFullScreenVideoAd(task, type, data);
        } else {
          uni.showToast({
    ...
    showFullScreenVideoAd: function showFullScreenVideoAd(task) {var _this3 = this;var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "finish";var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      // 调用后会显示 loading 界面
      _adMpWeixin.default.show(config, function (res) {
        _this3.loadVideoAdByConfig(config);
        // 用户点击了【关闭广告】按钮，后台允许中途退出
        if (res && res.isEnded || task.middle_getout) {
          // 正常播放结束
          _this3.finishTask(task, type, data);
          console.log("onClose " + res.isEnded);
        } else {
          // 播放中途退出
          console.log("中途退出onClose " + res.isEnded);
    ...
    showInterstitialAd: function showInterstitialAd() {var _this4 = this;
      ...
      _adMpWeixin.default.show(config, function (res) {
        _this4.loadVideoAdByConfig(config);
        // 用户点击了【关闭广告】按钮
        if (res && res.isEnded) {
          // 正常播放结束
          console.log("onClose " + res.isEnded);
    ...
    finishTask: function finishTask(task) {var _this5 = this;var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "finish";var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var isVideo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      var task_log_id = "";
      if (task.log && task.log._id) {
        task_log_id = task.log._id;
      }
      this.$request('user/task/' + type, _objectSpread(_objectSpread({
        data: task.data },
      data), {}, {
      ...
      then(function (res) {
        ...
        //更新任务日志amount,result
        _this5.$store.commit('user/UPDATE_TASK_LOG', res);
        //重新加载广告
        // this.loadVideoAd();
        _this5.showWaitAdTime(res, isVideo ? _this5.videoAdWaittingTime : 0);
      }, function (err) {
        uni.hideLoading();
      });
    },
    showWaitAdTime: function showWaitAdTime(res, number) {var _this6 = this;
      this.loaded = false;
      if (number > 0) {
        uni.showLoading({
          mask: true,
          title: "".concat(number, "\u79D2\u51B7\u5374\u65F6\u95F4") });

        this.adTimer = setTimeout(function () {
          _this6.showWaitAdTime(res, number - 1);
        }, 1000);
      } else {
        uni.hideLoading();
        this.loaded = true;
    ...
    /**
        ...
        * @param {Object} res
        */
    finishTaskResult: function finishTaskResult(res) {
      if (res.getDouble) {
        this.$message("\u83B7\u5F97\u7FFB\u500D\u5956\u52B1 +".concat(res.task.bounty));
      } else if (res.getScore) {
        this.$message("\u83B7\u5F97\u5956\u52B1 +".concat(res.task.bounty));
      } else if (res.needMore) {
        this.$message("\u5DF2\u5B8C\u6210".concat(res.amount, "\u6B21"));
      } else if (res.result) {
        this.$message("已完成");
      } else {
        uni.hideLoading();
    ...
    buildTaskResult: function buildTaskResult(log) {} } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 40:
/*!****************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/js/ad-mp-weixin.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;} //https://uniapp.dcloud.net.cn/api/a-d/rewarded-video
...
AdHelper = /*#__PURE__*/function () {
  ...
  function AdHelper() {_classCallCheck(this, AdHelper);
    ...
    options, onload, onerror) {} }, { key: "show", value: function show(

    options, onsuccess, onerror) {var _this = this;var
...
/***/ 41:
/*!***************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/mixin/share/mp.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 458:
/*!**********************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/js/marked.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 50:
/*!***************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/pages/login/mixin/app.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var weixinAuthService;var _default =
{};exports.default = _default;
...
/***/ 51:
/*!*********************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/pages/login/mixin/mp-alipay.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 52:
/*!*********************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/pages/login/mixin/mp-weixin.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default = {
  ...
  methods: {
    /**
              * 微信授权登录
              */
    wxLogin: function wxLogin() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                uni.login({
                  provider: "weixin",
                  success: function success(loginRes) {
                    console.log('loginRes', loginRes);
                    console.log('inviteCode', _this.inviteCode);
                    //微信获取用户信息，并登录 
                    _this.$request("user/login/weixin", {
                      inviteCode: _this.inviteCode,
                      channelCode: _this.$store.state.user.channelCode,
                      code: res.code }).
                    then(function (res2) {
                      _this.loginSuccess(res2);
                    }, function (err) {
                      //更新失败
                    });
    ...
    mpWxGetUserInfo: function mpWxGetUserInfo(userInfoData) {var _this2 = this;
      uni.getUserInfo({
        provider: "weixin",
        success: function success(res) {
          _this2.$request("user/login/weixin", {
            code: _this2.mpWxCode,
            channelCode: _this2.$store.state.user.channelCode,
            encryptedData: res.encryptedData,
            iv: res.iv,
            userInfo: res.userInfo }).
          then(function (res2) {
            _this2.loginSuccess(res2);
          }, function (err) {
            //更新失败
          });
        } });
...
/***/ 522:
/*!*********************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-forms/components/uni-forms/validate.js ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 544:
/*!**********************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-dateformat/components/uni-dateformat/date-format.js ***!
  \**********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 550:
/*!*******************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-load-more/components/uni-load-more/i18n/index.js ***!
  \*******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 551:
/*!******************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-load-more/components/uni-load-more/i18n/en.json ***!
  \******************************************************************************************************************************/
...
/***/ 552:
/*!***********************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hans.json ***!
  \***********************************************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 553:
/*!***********************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hant.json ***!
  \***********************************************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _en_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./en.json */ 576);
var _en_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./en.json */ 576, 1);
/* harmony import */ var _es_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./es.json */ 577);
var _es_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./es.json */ 577, 1);
/* harmony import */ var _fr_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fr.json */ 578);
var _fr_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./fr.json */ 578, 1);
/* harmony import */ var _zh_Hans_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./zh-Hans.json */ 579);
var _zh_Hans_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./zh-Hans.json */ 579, 1);
/* harmony import */ var _zh_Hant_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./zh-Hant.json */ 580);
var _zh_Hant_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./zh-Hant.json */ 580, 1);
...
/***/ 621:
/*!******************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-popup/components/uni-popup/popup.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 622:
/*!***********************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-popup/components/uni-popup/i18n/index.js ***!
  \***********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 623));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 624));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 625));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
/***/ 623:
/*!**********************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-popup/components/uni-popup/i18n/en.json ***!
  \**********************************************************************************************************************/
...
/***/ 624:
/*!***************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-popup/components/uni-popup/i18n/zh-Hans.json ***!
  \***************************************************************************************************************************/
/*! exports provided: uni-popup.cancel, uni-popup.ok, uni-popup.placeholder, uni-popup.title, uni-popup.shareTitle, default */
/***/ (function(module) {
...
/***/ 625:
/*!***************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-popup/components/uni-popup/i18n/zh-Hant.json ***!
  \***************************************************************************************************************************/
/*! exports provided: uni-popup.cancel, uni-popup.ok, uni-popup.placeholder, uni-popup.title, uni-popup.shareTitle, default */
/***/ (function(module) {
...
/***/ 633:
/*!*********************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-search-bar/components/uni-search-bar/i18n/index.js ***!
  \*********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 634));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 635));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 636));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
/***/ 634:
/*!********************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-search-bar/components/uni-search-bar/i18n/en.json ***!
  \********************************************************************************************************************************/
...
/***/ 635:
/*!*************************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hans.json ***!
  \*************************************************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 636:
/*!*************************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hant.json ***!
  \*************************************************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 644:
/*!******************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 671:
/*!******************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/Sansnn-uQRCode/components/uqrcode/common/uqrcode.js ***!
  \******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 679:
/*!********************************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-data-picker/components/uni-data-pickerview/uni-data-picker.js ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 69:
/*!******************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/common/js/ad.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
FullScreenVideo = /*#__PURE__*/function (_AdBase2) {_inherits(FullScreenVideo, _AdBase2);var _super2 = _createSuper(FullScreenVideo);
  ...
  }return FullScreenVideo;}(AdBase);var

Interstitial = /*#__PURE__*/function (_AdBase3) {_inherits(Interstitial, _AdBase3);var _super3 = _createSuper(Interstitial);
  function Interstitial() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, Interstitial);return _super3.call(this,
    plus.ad.createInterstitialAd(options), options);
  }return Interstitial;}(AdBase);var _default =
...
/***/ 799:
/*!**************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/tian-article/components/tian-article/layouts.js ***!
  \**************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  {
    image: '200x200',
    className: 'default' }] };exports.default = _default;

/***/ }),

/***/ 842:
/*!**************************************************************************************************************************************!*\
  !*** D:/xiaochengxu/uni_tiantianshangcheng/天天商城-多商户多级分销电商系统/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \**************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
